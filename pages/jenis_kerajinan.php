...
<body>
                ...
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            ...
                            <a href="jenis_kerajinan.php" class="dropdown-item active">Jenis Kerajinan</a>
                        </div>
                    </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="row g-4">
                <?php
                    $sql = "SELECT * FROM jenis_jenis_kerajinan ";
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="service-item rounded d-flex h-100">
                            ...
                            <div class="service-text rounded p-5 w-100">
                                ...
                                <a class="btn btn-sm" href="jenis_kerajinan_rincian.php?id=<?php echo $data['id']; ?>"><i class="fa fa-plus text-green1 me-2"></i>Selengkapnya</a>
                            </div>
                        </div>
                    </div>
                <?php } ?>
