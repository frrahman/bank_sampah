<?php
    include("../config.php");
    $id = $_GET['id'];
    $sql = "SELECT * FROM jenis_jenis_kerajinan WHERE id = '$id'";
?>
...
<body>
                ...
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            ...
                            <a href="kegiatan.php" class="dropdown-item active">Kegiatan PPK Ormawa</a>
    ...
    <div class="container-fluid page-header mb-5 wow fadeIn position-relative overlay-bottom" data-wow-delay="0.1s" style="background: linear-gradient(rgba(0, 29, 35, .8), rgba(0, 29, 35, .8)), url(../img/bg_sampah2.jpg) center center no-repeat; background-size: cover;">
        <div class="container text-center">
            <h1 class="display-4 text-white animated slideInDown mb-4">Jenis Jenis Kerajinan</h1>
        ...
        <div class="container">
            <div class="row">
                <?php
                    ...
                    {
                ?>
                    <div class="col-lg-12 col-md-12 wow slideInUp mt-4" data-wow-delay="0.1s">
                        <div class="blog-item bg-light rounded overflow-hidden" style="box-shadow: -3px 5px 15px rgba(0, 0, 0, .4);">
                            <div class="blog-img position-relative overflow-hidden">
                                <div class="responsive-kegiatan-rincian img-fluid img-kegiatan" style="background-image: url(../dashboard_admin/assets/img/jenis_jenis_kerajinan/<?php echo $data['foto'] ?>);"></div>
                            </div>
                            <div class="p-4">
                                <h4 class="mb-3"><?php echo $data['jenis_kerajinan'] ?></h4>
                                <p class="no-max-text"><?php echo $data['deskripsi'] ?></p>
                            </div>
                        </div>
                    </div>
                <?php } ?>
                <div class="col-lg-12 col-md-12 wow slideInUp mt-4">
