    ...
    <div class="container-fluid py-4" style="padding-right: 6rem !important; padding-left: 6rem !important;">
        ...
        <div class="row">
            <div class="col-12"></div>
                <div class="w-auto">
                    <div class="btn btn2 bg-gradient-primary mt-4 w-100" target="_blank" href="" type="button">
                        <form method="get">
                            <label class="font-label">PILIH TANGGAL</label>
                            <input class="font-input" type="date" name="tanggal">
                            <input class="font-filter" type="submit" value="FILTER">
                        </form>
                    </div>
                </div>
                <div class="w-auto">
                    <div class="btn btn2 bg-gradient-primary mt-4 w-100" target="_blank" href="" type="button">
                        <form method="get">
                            <label class="font-label">PILIH RT/RW</label>
                            <input class="font-input" type="text" name="nama_rtrw">
                            <input class="font-filter" type="submit" value="FILTER">
                        </form>
                    </div>
                </div>
                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                            <h6 class="text-white text-capitalize ps-3">Info Pemasukan Sampah</h6>
                        </div>
                    </div>
                        ...
                        <div class="table-responsive p-0">
                            <table class="table align-items-center mb-0">
                                <thead>
                                    ...
                                    <th class="text-center text-uppercase text-green1 text-xxs font-weight-bolder opacity-7">Nama RT/RW</th>
                                    ...
                                    <th class="text-center text-uppercase text-green1 text-xxs font-weight-bolder opacity-7">Total Sampah</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                        ...
                                        if(isset($_GET['nama_rtrw'])){
                                            $nama_rtrw = $_GET['nama_rtrw'];
                                            $query = mysqli_query($conn,"select * from bank_sampah where nama_rtrw='$nama_rtrw'");
                                        }elseif(isset($_GET['tanggal'])){
                                            $tgl = $_GET['tanggal'];
                                            $query = mysqli_query($conn,"select * from bank_sampah where tanggal='$tgl'");
                                        }else{
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-center text-xs font-weight-bold mb-0"><?php echo $data['nama_rtrw']; ?></td>
                                        ...
                                        <!-- <td class="align-middle text-center text-xs font-weight-bold mb-0" style="text-align: justify !important; white-space: inherit;" ><?php echo $data['semester']; ?></td> -->
                                        <td class="align-middle text-center text-xs font-weight-bold mb-0"><?php echo $data['jumlah_sampah']; ?> Kg</td>
                                        <!-- <td class="align-middle text-center text-xs font-weight-bold mb-0"><?php echo $hasil_total_sampah; ?></td>                        -->
                                        <td class="align-middle text-center text-sm">   
                                            <a href="bank_sampah_total.php?nama_rtrw=<?php echo $data['nama_rtrw']; ?>"><span class="badge badge-sm bg-gradient-success">Lihat</span></a>
                                        </td>                      
                                    </tr>
                                    <?php } ?>
                                </tbody>
