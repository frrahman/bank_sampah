<?php
    include("config.php");
    $sql = "SELECT * FROM pengurus_ppk_ormawa ";
        ...
        <nav class="navbar navbar-expand-lg navbar-light py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    <a href="pengurus.php" class="nav-item nav-link active">Pengurus</a>
    ...
    <div class="container-xxl py-5">
        <div class="container px-lg-5">
            <div class="section-title position-relative text-center mb-5 pb-2 wow fadeInUp" data-wow-delay="0.1s">
                <div class="d-inline-block rounded-pill bg-secondary text-green1 py-1 px-3 mb-3">Pengurus</div>
                        ...
                        <div class="team-item">
                            <div class="d-flex">
                                <div class="flex-shrink-0 d-flex flex-column align-items-center mt-4 pt-5" style="width: 75px;">
                                    <h6 class="vertical-text fw-bold m-0"><?php echo $data['jabatan']; ?></h6>
                                </div>
                                <div class="responsive-team" style="background-image: url(dashboard_admin/assets/img/pengurus_ppk_ormawa/<?php echo $data['foto'] ?>);"></div>
                                <!-- <img class="img-fluid rounded w-100" src="img/team-2.jpg" alt=""> -->
                            </div>
                            <div class="px-4 py-3">
                                <h5 class="fw-bold m-0"><?php echo $data['nama']; ?></h5>
                                <small>NIM    : <?php echo $data['nim']; ?></small><br>
                                <small>Kampus : <?php echo $data['asal_kampus']; ?></small>
                            </div>
                        </div>
                    </div>
                <?php } ?>
